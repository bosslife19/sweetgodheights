...
use App\Http\Controllers\Student\ScratchCardController;
...
Route::group(['middleware' => ['XSS', 'subdomain']], function () {
    ...
    Route::group(['middleware' => ['StudentMiddleware']], function () {
        ...
        // Student Result
        Route::get('enter-pin', [ScratchCardController::class, 'showPinForm'])->name('student.enter_pin');
Route::post('verify-pin', [ScratchCardController::class, 'verifyPin'])->name('student.verify_pin');
        Route::get('student-result', ['as' => 'student_result', 'uses' => 'Student\SmStudentPanelController@studentResult'])->middleware(['userRolePermission:student_result', 'check.scratch']);
        Route::post('student-result-download', ['as' => 'student_result-download', 'uses' => 'Student\SmStudentPanelController@download'])->middleware('userRolePermission:student_result');
