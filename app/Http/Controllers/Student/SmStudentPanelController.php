...
class SmStudentPanelController extends Controller
{
    ...
    ->toArray();
            ...
            if (moduleStatusCheck('University')) {
                ...
                return view('backEnd.studentPanel.student_result', compact('student_detail', 'exams', 'grades', 'exam_terms', 'failgpaname', 'optional_subject_setup', 'student_optional_subject', 'maxgpa', 'records', 'caScores'));
            }
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
    ...
    public function download(Request $request)
{
    ...
    //     return back()->with('error', 'Result not found or file is missing.');
    // }
