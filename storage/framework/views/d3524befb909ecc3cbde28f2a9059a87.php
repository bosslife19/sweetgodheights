...
if ($studentScore) {
    ...
    <h1>Report Sheet for <?php echo e($exam_details->title); ?> : <?php echo e(@$student_detail->academic->year); ?> Session</h1>
    <h2 class="school-name"><?php echo e(generalSetting()->school_name); ?></h2>
    <h3><?php echo e(generalSetting()->address); ?></h3>

    <table class="info-table">
        <tr>
            <td class="label">NAME</td>
            <td class="value"><?php echo e($student_detail->studentDetail->full_name); ?></td>
            <td class="label">SERIAL NO</td>
            <td class="value">: <?php echo e(@$student_detail->student->admission_no); ?></td>
        </tr>
        <tr>
            <td class="label">GENDER</td>
            <td class="value">FEMALE</td>
            <td class="label">CLASS</td>
            <td class="value"><?php echo e($student_detail->class->class_name); ?></td>
        </tr>

        <tr>
            <td class="label">TOTAL OBTAINED</td>
            <td class="value"><?php echo e(number_format($total_mark, 2)); ?></td>
            <td class="label">TOTAL OBTAINABLE</td>
            <td class="value"><?php echo e($totalObtainable); ?></td>
        </tr>
        <tr>
        ...
        if ($data->Attentiveness !== null) {
         ...
         if ($data['Handling Tools'] !== null) {
            $skills['Handling Tools'] = $data['Handling Tools'];
                                                                ...
                                                                ?>
                                                                            <tr class="<?php echo e($lowScoreClass ? 'low-score' : ''); ?>">
...
<?php endif; ?>
 <td>
                                                                    ...
                                                                    <td><?php echo e($subjectStats[$data->subject_id]['max'] ?? '-'); ?></td>
<td><?php echo e($subjectStats[$data->subject_id]['min'] ?? '-'); ?></td>
<td><?php echo e($subjectStats[$data->subject_id]['average'] ?? '-'); ?></td>

                                                                    <td>
    <?php echo e($subjectPosition['position'] ?? '-'); ?>
    ...
    <?php if(!empty($skills)): ?>
        ...
        <tr>
            ...
            <td><strong>Honesty</strong><?php echo e($affectiveSkills->Honesty); ?></td>
            <td><strong>Neatness</strong><?php echo e($affectiveSkills->Neatness); ?></td>
            <td><strong>Punctuality</strong><?php echo e($affectiveSkills->Punctuality); ?></td>
            <td><strong>Cooperation</strong><?php echo e($affectiveSkills->Cooperation); ?></td>
            <td><strong>Attentiveness</strong><?php echo e($affectiveSkills->Attentiveness); ?></td>
            <td><strong>Handwriting</strong><?php echo e($affectiveSkills->Handwriting); ?></td>
            <td><strong>Sports</strong><?php echo e($affectiveSkills->Sports); ?></td>
...
<p><strong>School Head Comment:</strong> <?php echo e($headComment); ?></p>
...
<?php /**PATH C:\xampp\htdocs\schoolmanagement1\resources\views/emails/studentresult.blade.php ENDPATH**/ ?>