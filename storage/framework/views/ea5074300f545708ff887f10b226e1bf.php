                                ...
                                <div class="col-lg-12">
                                    <div class="no-search no-paginate no-table-info mb-2">
                                        <?php $__currentLoopData = $exam_terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php $formRendered = false; ?>

<?php $__currentLoopData = $get_results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if(!$formRendered): ?>
        <form action="<?php echo e(route('student_result-download')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <input type="text" value="<?php echo e($result->class_id); ?>" name="class_id" hidden>
            <input type="text" value="<?php echo e($result->section_id); ?>" name="section_id" hidden>
            <input type="text" value="<?php echo e($result->exam_type_id); ?>" name="exam_id" hidden>
            <input type="text" value="<?php echo e($result->student_id); ?>" name="student_id" hidden>
            <input type="submit" value="View Result">
        </form>
        <?php $formRendered = true; ?>
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\schoolmanagement1\resources\views/backEnd/studentPanel/student_result.blade.php ENDPATH**/ ?>